...
interface PreTravelTableOfContentsProps {
  onNavigate: (index: number) => void;
}

const PreTravelTableOfContents: React.FC<PreTravelTableOfContentsProps> = ({ onNavigate }) => {
  return (
...
export default PreTravelTableOfContents;
