...
interface DailyPlansTableOfContentsProps {
  onNavigate: (index: number) => void;
}

const DailyPlansTableOfContents: React.FC<DailyPlansTableOfContentsProps> = ({ onNavigate }) => {
  return (
...
export default DailyPlansTableOfContents;
